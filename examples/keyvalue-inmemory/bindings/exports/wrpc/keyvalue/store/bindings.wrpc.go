...
func ServeInterface(s wrpc.Server, h Handler) (stop func() error, err error) {
	...
	stop0, err := s.Serve("wrpc:keyvalue/store@0.2.0-draft", "get", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wrpc:keyvalue/store@0.2.0-draft", "name", "get", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wrpc:keyvalue/store@0.2.0-draft", "name", "get", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wrpc:keyvalue/store@0.2.0-draft", "name", "get", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wrpc:keyvalue/store@0.2.0-draft", "name", "get", "err", err)
					}
				}()
			}
		}
	...
	stop1, err := s.Serve("wrpc:keyvalue/store@0.2.0-draft", "set", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wrpc:keyvalue/store@0.2.0-draft", "name", "set", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wrpc:keyvalue/store@0.2.0-draft", "name", "set", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wrpc:keyvalue/store@0.2.0-draft", "name", "set", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wrpc:keyvalue/store@0.2.0-draft", "name", "set", "err", err)
					}
				}()
			}
		}
	...
	stop2, err := s.Serve("wrpc:keyvalue/store@0.2.0-draft", "delete", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wrpc:keyvalue/store@0.2.0-draft", "name", "delete", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wrpc:keyvalue/store@0.2.0-draft", "name", "delete", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wrpc:keyvalue/store@0.2.0-draft", "name", "delete", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wrpc:keyvalue/store@0.2.0-draft", "name", "delete", "err", err)
					}
				}()
			}
		}
	...
	stop3, err := s.Serve("wrpc:keyvalue/store@0.2.0-draft", "exists", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wrpc:keyvalue/store@0.2.0-draft", "name", "exists", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wrpc:keyvalue/store@0.2.0-draft", "name", "exists", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wrpc:keyvalue/store@0.2.0-draft", "name", "exists", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wrpc:keyvalue/store@0.2.0-draft", "name", "exists", "err", err)
					}
				}()
			}
		}
	...
	stop4, err := s.Serve("wrpc:keyvalue/store@0.2.0-draft", "list-keys", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wrpc:keyvalue/store@0.2.0-draft", "name", "list-keys", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wrpc:keyvalue/store@0.2.0-draft", "name", "list-keys", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wrpc:keyvalue/store@0.2.0-draft", "name", "list-keys", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wrpc:keyvalue/store@0.2.0-draft", "name", "list-keys", "err", err)
					}
				}()
			}
		}
