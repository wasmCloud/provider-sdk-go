...
func TestLatticeTopics(t *testing.T) {
	...
	wasmCloudOneDotZero := HostData{ProviderKey: "providerfoo", LatticeRPCPrefix: "lattice123", ProviderXKeyPrivateKey: "", HostXKeyPublicKey: ""}
	...
	wasmCloudOneDotOne := HostData{ProviderKey: "providerfoo", LatticeRPCPrefix: "lattice123", ProviderXKeyPrivateKey: string(xkeyPrivateKey), HostXKeyPublicKey: xkeyPublicKey}
